...
///
/// ```
/// use pwf_application::note::remove::RemoveNote;
///
...
///
/// ```
/// use pwf_application::note::remove::RemovedNote;
/// use pwf_domain::note::NoteId;
///
...
///
/// ```
/// use pwf_application::note::remove::RemoveNoteError;
///
...
/// # use pwf_application::{
/// #     ProjectNoteStore,
/// #     note::remove::{self, RemoveNote, RemoveNoteError, RemovedNote},
...
/// #     S: ProjectNoteStore,
/// # {
/// remove::execute(request, store, projects)
/// # }
/// ```
#[cqrsy::command]
pub fn execute<S>(
    ...
    fn identifier_from_another_project_is_rejected() {
        ...
        assert!(matches!(
            ...
            RemoveNoteError::InvalidIdentifier {
                ref id,
                ref prefix,
            } if id == "GLP-NOTE-0001" && prefix == "PWF"
        ));
    }
