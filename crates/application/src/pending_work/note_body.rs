...
#[must_use]
pub(crate) fn is_placeholder_prompt(prompt: &str) -> bool {
    matches!(
...
#[must_use]
pub(crate) fn append_lanes(body: &str, prompt: &str) -> Option<String> {
...
#[must_use]
pub(crate) fn append_report_block(body: &str, report: &str) -> Option<String> {
...
#[must_use]
pub(crate) fn append_report(body: &str, report: &str) -> Option<String> {
